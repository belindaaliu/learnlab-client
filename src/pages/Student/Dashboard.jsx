      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {recommended.length > 0 && (
          <section ref={recommendedRef} className="mt-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {getCurrentRecommendedCourses().map((course) => (
                <div key={course.id}>
                  <CourseCard
                    course={course}
              ...
              <div className="flex items-center justify-center gap-4 mt-8">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200
                    ${recommendedCurrentPage === 0 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 hover:border-primary/30'}`}
                >
                ...
                <div className="flex items-center gap-2">
                  {Array.from({ length: Math.ceil(recommended.length / recommendedPerPage) }).map((_, index) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition-all duration-200 ${recommendedCurrentPage === index ? 'w-6 bg-primary' : 'bg-gray-300 hover:bg-gray-400'}`}
                    />
                  ))}
                </div>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200
                    ${recommendedCurrentPage >= Math.ceil(recommended.length / recommendedPerPage) - 1 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 hover:border-primary/30'}`}
                >
                  Next
        ...
        <section ref={featuredRef} className="mt-20">
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3 rounded-xl font-medium text-sm transition-all duration-200
                    ${isActive ? 'bg-primary text-white shadow-md shadow-primary/25' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200'}`}
                >
          ...
          {featuredCourses.length > 0 && (
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {getCurrentFeaturedCourses().map((course) => (
                  <div key={course.id}>
                    <CourseCard
                      course={course}
                      onAddToCart={() => handleAddToCart(course.id)}
              ...
              {featuredCourses.length > featuredCoursesPerPage && (
                <div className="flex items-center justify-center gap-4 mt-8">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200
                      ${featuredCurrentPage === 0 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 hover:border-primary/30'}`}
                  >
                    <ChevronLeft className="w-4 h-4" />
                    Previous
                  </button>
                  ...
                  <div className="flex items-center gap-2">
                    {Array.from({ length: Math.ceil(featuredCourses.length / featuredCoursesPerPage) }).map((_, index) => (
                      <button
                        ...
                        className={`w-2 h-2 rounded-full transition-all duration-200 ${featuredCurrentPage === index ? 'w-6 bg-primary' : 'bg-gray-300 hover:bg-gray-400'}`}
                      />
                    ))}
                  </div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200
                      ${featuredCurrentPage >= Math.ceil(featuredCourses.length / featuredCoursesPerPage) - 1 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 hover:border-primary/30'}`}
                  >
                    Next
                    <ChevronRight className="w-4 h-4" />
                  </button>
