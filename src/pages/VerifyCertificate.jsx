...
const VerifyCertificate = () => {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_API_URL}/public/verify-certificate/${certId}`)
  ...
  if (error) return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-4">
      ...
      <p className="text-gray-500">This certificate ID could not be verified in our records.</p>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 border-t-8 border-primary">
        ...
        <h1 className="text-2xl font-bold text-center mb-2">Verified Certificate</h1>
        <p className="text-center text-gray-500 mb-8">This document is authentic and issued by our platform.</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-xl">
            ...
            <p className="text-lg font-semibold text-gray-900">{new Date(data.issuedAt).toLocaleDateString()}</p>
          </div>
        </div>
